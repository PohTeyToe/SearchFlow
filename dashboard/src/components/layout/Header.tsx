...
export const Header: React.FC<HeaderProps> = ({ title, subtitle, actions, breadcrumbs }) => {
    ...
    return (
        <header className="h-14 sticky top-0 z-30 flex items-center justify-between px-6 border-b border-[var(--border-subtle)]" style={{ backgroundColor: 'oklch(0.07 0 0 / 0.8)', backdropFilter: 'blur(12px)' }}>
